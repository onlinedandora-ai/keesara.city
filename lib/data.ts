...
const FALLBACK_BUSINESSES: Business[] = [
  ...
  {
    id: "re-1",
    name: "KVR Landmark-2 @ Keesara (Mee Illu Mee Ishtam)",
    slug: "kvr-landmark-2-keesara",
    category_id: "cat-1",
    ...
    address: "KVR Landmark-2, ECIL - Keesara Road, 300m from ORR Exit 8, Keesara 501301",
    phone: "+91 90100 28800",
    location_url: "https://maps.google.com/?q=KVR+Landmark-2+Keesara",
    website: "https://keesara.city/mee-illu-mee-istam",
    lat: 17.53,
    lng: 78.648,
    claimed_by: null,
    status: "active",
