  ...
  return (
    <section className="w-full bg-paper pt-3 sm:pt-4 pb-1 sm:pb-2 px-3 sm:px-6">
      <div className="mx-auto max-w-4xl overflow-hidden rounded-xl sm:rounded-2xl border border-amber-500/30 bg-[#faf6ee] shadow-xs sm:shadow-sm transition-all duration-300 hover:shadow-md hover:border-amber-500/50">
        <Link href={HOUSE_AD.href} className="group relative block w-full">
          {/* Ad Type Badge */}
          ...
          {/* Banner Container: On mobile aspect-[1024/394] preserves complete image clarity; on sm+ thin height */}
          <div className="relative aspect-[1024/394] sm:aspect-none sm:h-36 md:h-44 w-full overflow-hidden">
            <Image
              src={HOUSE_AD.bannerImage}
              alt="మీ ఇల్లు మీ ఇష్టం — Keesara Builders & Developers"
              fill
              className="object-contain sm:object-cover object-center transition-transform duration-500 group-hover:scale-[1.005]"
              priority
